...
class ReactionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reaction" do
    assert_difference("Reaction.count") do
      post reactions_url, params: { reaction: { dislike: @reaction.dislike, like: @reaction.like, post_id: @reaction.post_id, user_id: @reaction.user_id } }
    end
  ...
  test "should update reaction" do
    patch reaction_url(@reaction), params: { reaction: { dislike: @reaction.dislike, like: @reaction.like, post_id: @reaction.post_id, user_id: @reaction.user_id } }
